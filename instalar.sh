...
funcao_idioma () {
msg -bar2
declare -A idioma=( [1]="en English" [2]="fr French" [3]="de German" [4]="it Italian" [5]="pl Polish" [6]="pt Portuguese" [7]="es Spanish" [8]="tr Turkish" )#!/bin/bash
cd $HOME
SCPdir="/etc/newadm"
SCPinstal="$HOME/install"
SCPidioma="${SCPdir}/idioma"
...
fun_ip
wget -O /usr/bin/trans https://raw.githubusercontent.com/sauceisgood/admultimate/master/Install/trans &> /dev/null
msg -bar2
